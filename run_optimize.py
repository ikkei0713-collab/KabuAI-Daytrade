...
PARAM_SPACE = {
    "vwap_reclaim": {
        "min_time_below_vwap": [10, 15, 20, 30],
        "min_volume_ratio": [1.0, 1.2, 1.5, 2.0],
        "atr_stop_multiple": [1.0, 1.5, 2.0, 2.5],
        "atr_target_multiple": [1.0, 1.5, 2.0, 2.5, 3.0],
        "max_holding_minutes": [30, 45, 60, 90],
    },
    "spread_entry": {
        "min_volume_building": [1.2, 1.5, 1.8, 2.0, 2.5],
        "atr_stop_multiple": [0.5, 0.7, 1.0],
        "atr_target_multiple": [0.8, 1.0, 1.5],
    },
    "vwap_bounce": {
        "min_volume_ratio": [1.0, 1.2, 1.5],
        "atr_stop_multiple": [0.3, 0.5, 0.7],
        "atr_target_multiple": [0.8, 1.0, 1.5],
    },
    "orb": {
        "min_volume_ratio": [1.0, 1.5, 2.0],
        "breakout_buffer_yen": [0.5, 1.0, 2.0],
        "target_range_multiple": [1.0, 1.5, 2.0, 2.5],
        "max_holding_minutes": [15, 30, 45, 60],
    },
    "trend_follow": {
        "min_volume_ratio": [1.0, 1.2, 1.5],
        "atr_target_multiple": [2.0, 3.0, 4.0],
    },
}
